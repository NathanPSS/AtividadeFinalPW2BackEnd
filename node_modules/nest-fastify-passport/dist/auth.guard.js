...
const createPassportContext = (request, response) => (type, options, callback) => new Promise((resolve, reject) => passport_1.default.authenticate(type, options, (err, user, info, status) => __awaiter(void 0, void 0, void 0, function* () {
    try {
